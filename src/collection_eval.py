...
if __name__ == '__main__':
    ...
    models_coll_gini = {}
    print(f'computing metrics and gini for {retrieved_res_file}')
    df = convert.convert_res2docdf(retrieved_res_file, config.trec_res_columns)
    ...
    metrics = fair_utils.compute_metrics(config.qrels_res_dev, retrieved_res_file)
